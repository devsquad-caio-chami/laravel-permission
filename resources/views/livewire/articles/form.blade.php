                            ...
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3">
                                        ...
                                        <input type="text" wire:model.defer="article.name" name="name" id="name"
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select wire:model.defer="article.section_id" id="section_id" name="section_id"
                                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        @foreach ($sections as $section)
                                            <option value="{{ $section->id }}">{{ $section->name }}</option>
                                        @endforeach
                                    </select>
                                    <x-jet-input-error for="article.section_id" class="mt-2" />
                                </div>
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3">
                                        ...
                                        <textarea wire:model.defer="article.content" id="content" name="content"
                                            rows="3"
