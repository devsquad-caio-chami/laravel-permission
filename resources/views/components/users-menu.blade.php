    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            ...
            <a
                ...
                @class([
                    'group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm',
                    'border-indigo-500 text-indigo-600' => Route::is('roles.index'),
                    'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' => !Route::is('roles.index')
                ])
            >
                <svg
                    @class([
                        '-ml-0.5 mr-2 h-5 w-5',
                        'text-indigo-500' => Route::is('roles.index'),
                        'text-gray-400 group-hover:text-gray-500' => !Route::is('roles.index')
                    ])
                    class="text-indigo-500 "
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
